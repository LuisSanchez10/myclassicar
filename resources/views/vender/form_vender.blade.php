<section id="form_vender" class="container" >
    <div class="row justify-content-center">
      <div class="col-12 col-sm-9 my-sm-5 my-2 p-5 contenedorFormVender">
        <form id="form-vender" action="VenderController" method="POST" enctype="multipart/form-data" >
          @csrf
          <input type="hidden" id="usuario_id" name="usuario_id" value='{{Auth::user()->id}}'>
        <div class="row">
          <h1 class="col-sm-auto col-8  form_titulo">Vendé tu auto clásico</h1>
        ...
        @include('vender.seccion-vehiculo')
        <div class="row">
          <strong class="col-12 form-subtitulo  disabled paso-2">2.Ficha Técnica</strong>
        </div>
        <hr>
        {{-- incluir seccion de ficha_tenica --}}
        @include('vender.seccion-ficha')
        <div class="row">
          <strong class="col-12  form-subtitulo disabled paso-3">3.Fotos</strong>
        </div>
        <hr>
          {{-- incluir seccion de ficha_tenica --}}
          @include('vender.seccion-fotos')
        <div class="row">
          <strong class="col-12 form-subtitulo disabled paso-4">4.Datos de venta</strong>
        </div>
        <hr>
        {{-- incluir seccion de ficha_tenica --}}
        @include('vender.seccion-datos_venta')
        </form>
      </div>
    </div>
  </section>
